        ...
        "/api/resources/pause": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Destination path (same as upload)",
                        "name": "path",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Source name (same as upload)",
                        "name": "source",
                        "in": "query",
                        "required": true
                    }
        ...
        "/public/api/resources/pause": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Path within the share (same as upload)",
                        "name": "path",
                        "in": "query",
                        "required": true
                    }
